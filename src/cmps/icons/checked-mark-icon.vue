<template>
    <svg viewBox="0 0 20 20" fill="white" width="16" height="16" aria-hidden="true"
        class="icon_component monday-style-checkbox__icon icon_component--no-focus-style">
        <path
